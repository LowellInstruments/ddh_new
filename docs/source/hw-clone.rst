...
Your DDH is already considering cell-network capabilities, so be careful with data usage, if any request to Internet is done. Recall removing your wi-fi networks from the cloned DDH, if so.


Running it for the first time
-----------------------------

First time you boot a new SSD you may find a blank screen. Just unplug the power. Wait 5 minutes (ensure the RPI red led is off) and try again.
